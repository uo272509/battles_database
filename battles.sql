...
COPY enum_codead(value_table, description) FROM 'data\enum_codead.csv' DELIMITER ';' CSV HEADER;
COPY enum_aeroa(value_table, description) FROM 'data\enum_aeroa.csv' DELIMITER ';' CSV HEADER;
COPY enum_pri(value_table, description) FROM 'data\enum_pri.csv' DELIMITER ';' CSV HEADER;
COPY enum_wx1(value_table, description) FROM 'data\enum_wx1.csv' DELIMITER ';' CSV HEADER;
COPY enum_wx2(value_table, description) FROM 'data\enum_wx2.csv' DELIMITER ';' CSV HEADER;
COPY enum_wx3(value_table, description) FROM 'data\enum_wx3.csv' DELIMITER ';' CSV HEADER;
COPY enum_wx4(value_table, description) FROM 'data\enum_wx4.csv' DELIMITER ';' CSV HEADER;
COPY enum_wx5(value_table, description) FROM 'data\enum_wx5.csv' DELIMITER ';' CSV HEADER;
COPY enum_terra1(value_table, description) FROM 'data\enum_terra1.csv' DELIMITER ';' CSV HEADER;
COPY enum_terra2(value_table, description) FROM 'data\enum_terra2.csv' DELIMITER ';' CSV HEADER;
COPY enum_terra3(value_table, description) FROM 'data\enum_terra3.csv' DELIMITER ';' CSV HEADER;
COPY enum_postype(value_table, description) FROM 'data\enum_postype.csv' DELIMITER ';' CSV HEADER;
COPY enum_surpa(value_table, description) FROM 'data\enum_surpa.csv' DELIMITER ';' CSV HEADER;
COPY enum_crit(value_table, description) FROM 'data\enum_crit.csv' DELIMITER ';' CSV HEADER;
COPY enum_cea(value_table, description) FROM 'data\enum_cea.csv' DELIMITER ';' CSV HEADER;
COPY enum_wina(value_table, description) FROM 'data\enum_wina.csv' DELIMITER ';' CSV HEADER;
COPY enum_post(value_table, description) FROM 'data\enum_post.csv' DELIMITER ';' CSV HEADER;
COPY enum_reso(value_table, description) FROM 'data\enum_reso.csv' DELIMITER ';' CSV HEADER;


COPY battles(isqno, war, b_name, locn, campgn, postype, post1, post2, front, b_depth, b_time, aeroa, surpa, cea, leada, trnga, morala, logsa, momnta, intela, techa, inita, wina, kmda, crit, quala, resa, mobila, aira, fprepa, wxa, terra, leadaa, plana, surpaa, mana, logsaa, fortsa, deepa, is_hero, war2, war3, war4, war4_theater, dbpedia, cow_warno, cow_warname, war_initiator, parent) FROM 'data\battles.csv' DELIMITER ';' CSV HEADER;


COPY weather(isqno, wxno, wx1, wx2, wx3, wx4, wx5) FROM 'data\weather.csv' DELIMITER ';' CSV HEADER;
COPY battle_dyads(isqno, attacker, defender, wt, dyad, direction, bd_primary) FROM 'data\battle_dyads.csv' DELIMITER ';' CSV HEADER;
COPY battle_durations(isqno, datetime_min, datetime_max, date_time, duration1, duration2) FROM 'data\battle_durations.csv' DELIMITER ';' CSV HEADER;

COPY battle_actors(isqno, attacker, n, actor) FROM 'data\battle_actors.csv' DELIMITER ';' CSV HEADER;

COPY commanders(isqno, attacker, actors, commanders, uri) FROM 'data\commanders.csv' DELIMITER ';' CSV HEADER;
COPY front_widths(isqno, front_number, wofa, wofd, time_min, time_max) FROM 'data\front_widths.csv' DELIMITER ';' CSV HEADER;
COPY belligerents(isqno, attacker, nam, co, str, code, intst, rerp, cas, finst, cav, tank, lt, mbt, arty, fly, ctank, carty, cfly, pri1, pri2, pri3, sec1, sec2, sec3, reso1, reso2, reso3, strpl, strmi, caspl, casmi, ach, actors) FROM 'data\belligerents.csv' DELIMITER ';' CSV HEADER;
COPY active_periods(isqno, atp_number, start_time_min, start_time_max, end_time_min, end_time_max, duration_min, duration_max, duration_only) FROM 'data\active_periods.csv' DELIMITER ';' CSV HEADER;
COPY terrain(isqno, terrano, terra1, terra2, terra3) FROM 'data\terrain.csv' DELIMITER ';' CSV HEADER;
